export let list = [
	...
	{ code: 'BO', code3: 'BOL', name: 'Bolivia (Plurinational State of)', name1: 'Bolivia', number: '068' },
	// { "code": "BQ", "code3": "BES", "name": "Bonaire, Sint Eustatius and Saba", "number": "535" },
	{ code: 'BA', code3: 'BIH', name: 'Bosnia and Herzegovina', name1: 'Bosnia y Herzegovina', number: '070' },
	...
	{ code: 'GQ', code3: 'GNQ', name: 'Equatorial Guinea', name1: 'Guinea Ecuatorial', number: '226' },
	...
	{ code: 'IR', code3: 'IRN', name: 'Iran (Islamic Republic of)', name1: 'Irán', number: '364' },
	...
	{ code: 'KR', code3: 'KOR', name: 'Korea (the Republic of)', name1: 'Corea del Sur', number: '410' },
	...
	{ code: 'MD', code3: 'MDA', name: 'Moldova (the Republic of)', name1: 'Moldavia', number: '498' },
	...
	{ code: 'NL', code3: 'NLD', name: 'Netherlands (the)', name1: 'Países Bajos', number: '528' },
	...
	{ code: 'PG', code3: 'PNG', name: 'Papua New Guinea', name1: 'Papúa Nueva Guinea', number: '598' },
